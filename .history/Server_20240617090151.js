...
app.listen(port, () => { // Start the Express server
    console.log('Express server listening on port', port); // Log message indicating the server is listening
    console.log('Port open', port); // Log message indicating the port is open
});
